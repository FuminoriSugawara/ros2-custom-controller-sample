...
namespace custom_velocity_controller
{
  ...
  {
    auto ret = velocity_controllers::JointGroupVelocityController::on_init();
  ...
  {
    auto ret = velocity_controllers::JointGroupVelocityController::on_configure(previous_state);
    if (ret != controller_interface::CallbackReturn::SUCCESS)
    {
      return ret;
    }
  ...
  {
    auto result = velocity_controllers::JointGroupVelocityController::update(time, period);
